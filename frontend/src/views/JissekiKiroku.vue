      ...
      <v-layout>
        ...
        <v-flex md7>
          ...
          >
            ...
            <wj-flex-grid-column header="入院・外泊時加算" binding="kasan1" :width="'15*'" :wordWrap=true aggregate="Sum"></wj-flex-grid-column>
            <wj-flex-grid-column header="入院時支援特別加算" binding="kasan2" :width="'15*'" :wordWrap=true aggregate="Sum"></wj-flex-grid-column>
            <wj-flex-grid-column header="地域移行加算" binding="tnymd" :width="'15*'" :wordWrap=true aggregate="Sum"></wj-flex-grid-column>
            <wj-flex-grid-column header="体験宿泊支援加算" binding="kasantkn" :width="'15*'" :wordWrap=true aggregate="Sum"></wj-flex-grid-column>
            <wj-flex-grid-column header="重度障害者支援加算" binding="kasanj" :width="'15*'" :wordWrap=true aggregate="Sum"></wj-flex-grid-column>
            ...
            <wj-flex-grid-column header="光熱水費" binding="" :width="'12*'" :wordWrap=true allowMerging="true"></wj-flex-grid-column>
            ...
            <wj-flex-grid-column header="光熱水費" binding="" :width="'12*'" :wordWrap=true allowMerging="true"></wj-flex-grid-column>
            <wj-flex-grid-column header="備考" binding="biko" :width="'40*'" :wordWrap=true></wj-flex-grid-column>
          </wj-flex-grid>
        </v-flex>
      </v-layout>
    </v-container>
...
export default{
  ...
  data(){
    return{
      ...
      tkkfhiumuData:JSON.parse(getOriginalDetailData())['riyo_inf'][0]['tkkfhiumu'],
