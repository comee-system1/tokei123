<template>
    <v-sheet class="clssheet-chu008" elevation="2">
      <label class="clsstitle1_Noreki_back_008" v-show="Label_Visible">
        <label class="clsstitle1_Noreki_008" >履歴を作成してください</label>
      </label>          
        <div class="area008-001">
            <label class="clsstitle008-001">医療保険情報</label>
        ...
        <div class="area008-003">
            ...
            <div class="area008-003-002">
                ...
                <input type="text" id="clssinp008-002_id" class="clssinp008-002" v-model="dispKigo" @input="text_input(0)"/>
                <v-radio-group :disabled="Label_Visible == true" row v-model="radio003" class="radiogroup001" style="margin-top:-10px">
        ...
        <div class="area008-004">
            ...
            <div class="area008-004-003">
                ...
                <input type="text" id="clssinp008-013_id" class="clssinp008-013" v-model="dispsonota"  @input="text_input(1)"/>
