<template>
    <v-sheet class="clssheet-chu015" elevation="2">
      ...
      <label class="clsstitle1_Noreki_back_015" v-show="Label_Visible">
        <label class="clsstitle1_Noreki_015" >履歴を作成してください</label>
      </label>
        ...
        <div class="area015-003">
          ...
          <wj-flex-grid-column header="関係機関名" binding="kankei_kikanname" :width="210"  :allowResizing=false  ></wj-flex-grid-column>
          <wj-flex-grid-column header="区分" binding="kankei_kikankbnname" :width="60" :wordWrap=true :allowResizing=false align="center"></wj-flex-grid-column>
          <wj-flex-grid-column header="連絡先" binding="kankei_renrakusaki" :width="180" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
          <wj-flex-grid-column header="担当者" binding="kankei_tantoname" :width="180" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
          <wj-flex-grid-column header="備考" binding="kankei_biko" :width="260" :wordWrap=true :allowResizing=false multiLine="true"></wj-flex-grid-column>
        ...
        <v-date-picker
            ...
            :day-format="(date) => new Date(date).getDate()"
            @change="monthSelect"
            @mousedown="win_drag_ymd($event)"
            @mousemove="win_move_ymd($event)"
            @mouseup="win_up_ymd($event)">
          </v-date-picker>
        </v-dialog>        
        ...
        <v-sheet id="rireki_id015" class="clssheet-Reki" elevation="2"
       ...
       <!-- ヘッダダイアログエリア --> 
          ...
          <v-sheet class="clssheet-chu016" elevation="2">
            ...
            <div class="areainput015_1">
              ...
              <div class="area016-003">
                  ...
                  <input type="text" v-model="dispkankei_nm" id="clssinp016-001_id" class="clssinp016-001"  @input="text_input(0)" readonly>
              </div>

              <div class="area016-004">
                <label class="clsstitle016-003">連絡先</label>
                <input type="text" id="clssinp016-002_id" class="clssinp016-002" v-model="disprenraku" @input="text_input(0)">
              </div>

              <div class="area016-005">
                <label class="clsstitle016-004">担当者</label>
                <input type="text" id="clssinp016-003_id" class="clssinp016-003" v-model="disptantou" @input="text_input(1)">
              </div>

              <div class="area016-006">
                <label class="clsstitle016-005">備考</label>
                <textarea type="text" id="clssinp016-004_id" class="clssinp016-004" v-model="dispbikou" @input="text_input(2)"/>
              </div>
              </div>
              ...
              <div >
                ...
                <wj-flex-grid
                  ...
                  >
                  <!--列-->
                  <wj-flex-grid-column header="事業所名" binding="name" :width="270"   :allowResizing=false></wj-flex-grid-column>
                  <wj-flex-grid-column header="" binding="kankei_kikanid_kbn" :width="0" :allowResizing=false ></wj-flex-grid-column>
                  <wj-flex-grid-column header="" binding="kankei_kikanid" :width="0"  :allowResizing=false ></wj-flex-grid-column>
        ...
        <v-dialog v-model="dialog_Sort_flg" width="1020" >
          <v-sheet id="sort_002id" class="clssheet015-sort" elevation="2">
            ...
            <wj-flex-grid
            id="Gridicrnsort015-id"
            class="Gridicrn015-sort"
            :headersVisibility="'Column'"
            :autoGenerateColumns="false"
            :allowAddNew="false"
            :allowDelete="false"
            ...
            <wj-flex-grid-column header=" " binding="kankei_no" :width="30"  :allowResizing=false  ></wj-flex-grid-column>  
            <wj-flex-grid-column header="関係機関名" binding="kankei_kikanname" :width="210"  :allowResizing=false  ></wj-flex-grid-column>
            <wj-flex-grid-column header="区分" binding="kankei_kikankbnname" :width="60" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="連絡先" binding="kankei_renrakusaki" :width="180" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="担当者" binding="kankei_tantoname" :width="180" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="備考" binding="kankei_biko" :width="260" :wordWrap=true :allowResizing=false multiLine="true"></wj-flex-grid-column>
            <wj-flex-grid-column header="表示順" binding="kankei_no_text" :width="60"  :allowResizing=false ></wj-flex-grid-column>
