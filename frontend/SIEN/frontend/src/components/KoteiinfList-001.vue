<template>
    <v-sheet class="clssheet-chu1" elevation="2">
        ...
        <div class="area002">
            <v-btn :disabled="Label_Visible == true" id="clsbtnmenu-copy-id" class="clsbtnmenu-copy"
                @click="onClickCopy">
                前回コピー
            </v-btn>
            <v-btn :disabled="Label_Visible == true" id="clsbtnmenu-reki-id" class="clsbtnmenu-reki"
                @click="onClickReki">
                履歴参照
            </v-btn>
        </div>
        ...
        <div class="area005">
            ...
            <input type="text" id="clslbl20_id" class="clslbl20" v-model="dispMail" style="ime-mode:active;"
                @input="text_input(0)" @click="click_text" />
            <label class="clsstitle21">携帯番号</label>
            <input type="text" id="clslbl21_id" class="clslbl21" v-model="dispPhoneNo" style="ime-mode: inactive;"
                @input="text_input(1)" @click="click_text" />
        </div>
        <div class="area006">
            <label class="clsstitle30">携帯ﾒｰﾙ</label>
            <input type="text" id="clslbl30_id" class="clslbl30" v-model="dispKMail" style="ime-mode: inactive;"
                @input="text_input(2)" @click="click_text" />
            <label class="clsstitle31">FAX番号</label>
            <input type="text" id="clslbl31_id" class="clslbl31" v-model="dispFaxNo" style="ime-mode: inactive;"
        ...
        <div class="area007">
            ...
            <div v-show="Grid_Visible" class="area007-3">
                <wj-flex-grid id="GridMst_id" class="GridMst" :headersVisibility="'Column'" :autoGenerateColumns="false"
        ...
        <div class="area010">
            ...
            <textarea id="textarea" class="clslbl70" v-model="dispTok" @click="click_text" @input="initTextarea"
                style="ime-mode: active;" no-resize rows="4">
        </textarea>
        </div>
        <br>
        <div class="area011">
        ...
        <v-dialog v-model="InsWinhead" width="255">
            <v-sheet class="clssheet-head" elevation="2" id="head_win_id" @mousedown="win_drag($event)"
        ...
        <v-dialog v-model="Rirekiwin" width="210">
            <v-sheet id="rireki_id" class="clssheet-Reki" elevation="2" @mousedown="win_drag_reki($event)"
                ...
                <div class="areaReki2">
                    <wj-flex-grid id="GrdReki_id" class="GrdReki-001" :headersVisibility="'Column'"
                        ...
                        :itemsSourceChanged="onItemsSourceChanged" :itemsSource="viewdata">
