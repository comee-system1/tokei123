    ...
    <v-sheet class="clssheet-chu2" elevation="2">
      ...
      <label class="clsstitle1_Noreki_back_002" v-show="Label_Visible">
        ...
        <div class="area002-001">
            <v-btn :disabled="Label_Visible == true" class="clsbtnmenu-copy" id="clsbtnmenu-copy-002" @click="onClickCopy">
            前回コピー
            </v-btn>
            <v-btn :disabled="Label_Visible == true" class="clsbtnmenu-reki" id="clsbtnmenu-reki-002" @click="onClickReki">
            履歴参照
            </v-btn>
        </div>
        <br>
        <wj-flex-grid
          ...
          <!--列-->
          <wj-flex-grid-column header="年月頃" binding="seikatu_ymdkoro" :width="313" :wordWrap=true :allowResizing=false  ></wj-flex-grid-column>
          <wj-flex-grid-column header="経過記録" binding="seikatu_naiyo" :width="613" :wordWrap=true :allowResizing=false multiLine="true"></wj-flex-grid-column>
          <wj-flex-grid-column header="" binding="seikatu_id" :width="0"  :allowResizing=false ></wj-flex-grid-column>
            ...
            <div class="area002-002">
              ...
              <v-btn  :disabled="Label_Visible == true" class="clsbtnmenu002-hyoji" id="btn_hyoji_002" @click="onClickSort">
                表示順変更
              </v-btn> 
            </div>
            ...
            <div class="area002-003" >
              ...
              <v-btn :disabled="Label_Visible == true" id="clsbtnmenu-ins-id" class="clsbtnmenu002-ins" @click="onClickIns_reki">
                登  録
              </v-btn>
        </div>
      ...
      <v-dialog v-model="InsWindata" width="760"  >
        ...
        <!--動作が不安定なためコメントアウト
          ...
          <div class="wrap003-003">
              ...
              <input type="text" class="kotei003inp1" v-model="dispymdkoro" id ="txtymdkoro" @input="text_input(0)"/>
          </div>

          <div class="wrap003-004">
              <label class="kotei003title2">経過記録</label>
              <textarea class="kotei003inp2" 
              v-model="dispkeika" id ="txtkeika"
              @input="initTextarea"
              no-resize
              rows="10">
            </textarea>
        ...
        <v-sheet id="rireki_id002" class="clssheet-Reki" elevation="2"
        ...
        <v-dialog v-model="dialog_Sort_flg" width="1020" >
          ...
          -->
            ...
            <!--列-->
            <wj-flex-grid-column header="年月頃" binding="seikatu_ymdkoro" :width="315"  :allowResizing=false  ></wj-flex-grid-column>
            <wj-flex-grid-column header="経過記録" binding="seikatu_naiyo" :width="615" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="" binding="seikatu_id" :width="0"  :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="表示順" binding="seikatu_no_text" :width="60"  :allowResizing=false ></wj-flex-grid-column>
