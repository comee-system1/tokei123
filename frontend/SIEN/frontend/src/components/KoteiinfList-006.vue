<template>
    <v-sheet class="clssheet-chu006" elevation="2">
        ...
        <wj-flex-grid id="Gridicrn006-id" class="Gridicrn006-001" :headersVisibility="'Column'"
        ...
        <v-dialog v-model="InsWinhead" width="270">
            <v-sheet class="clssheet-head" elevation="2" id="head_win_006id" @mousedown="win_drag($event)"
                ...
                <div class="areahead">
                    ...
                    <v-btn elevation="2" icon small top class="closeButton" color="red" @click="Click_colse_head">
                ...
                <div class="area007-All">
                    <div class="area007-Left">
                        ...
                        <div class="area007-003">
                            ...
                            <input type="text" class="clssinp007-004" v-model="dispiryo" @click="text_click(0)"
                                readonly />
                        </div>
                    ...
                    <div class="area007-Right">
                        <wj-flex-grid id="GridMst_id" class="GridMst06" :headersVisibility="'Column'"
                            :autoGenerateColumns="false" :allowAddNew="false" :allowDelete="false" :allowPinning="false"
                            :allowMerging="'AllHeaders'" :allowResizing="true" :allowSorting="false"
                            :allowDragging="false" :selectionMode="'Row'" :isReadOnly="true"
                            :initialized="onInitializeIcrnGrid_Mst" :itemsSourceChanged="onItemsSourceChanged_Mst"
                            :itemsSource="MstList">
                            <!--列-->
                            <wj-flex-grid-column header="" binding="name" :width="190" :wordWrap=true
                                :allowResizing=false id="MstGrid_col1"></wj-flex-grid-column>
