<template>
    <v-sheet class="clssheet-chu009" elevation="2">
        ...
        <label class="clsstitle1_Noreki_back009" v-show="Label_Visible">
            <label class="clsstitle1_Noreki009" >履歴を作成してください</label>
        </label>        
        ...
        <div class="area009-004">
            ...
            :itemsSource="viewdata_day"
            :itemsSourceChanged="onItemsSourceChanged_day"
            :autoRowHeights="true"
            >
            ...
            <wj-flex-grid-column header=" " binding="data_kbn" :width="100" :wordWrap=true :allowResizing=false align="center"></wj-flex-grid-column>
            <wj-flex-grid-column header="06:00" binding="data_0600_am" id="06:00" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="06:00" binding="data_0600_am2" id="06:00_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="06:00" binding="data_0600_pm" id="06:30" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="06:00" binding="data_0600_pm2" id="06:30_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="07:00" binding="data_0700_am" id="07:00" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="07:00" binding="data_0700_am2" id="07:00_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="07:00" binding="data_0700_pm" id="07:30" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="07:00" binding="data_0700_pm2" id="07:30_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="08:00" binding="data_0800_am" id="08:00" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="08:00" binding="data_0800_am2" id="08:00_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="08:00" binding="data_0800_pm" id="08:30" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="08:00" binding="data_0800_pm2" id="08:30_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="09:00" binding="data_0900_am" id="09:00" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="09:00" binding="data_0900_am2" id="09:00_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="09:00" binding="data_0900_pm" id="09:30" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="09:00" binding="data_0900_pm2" id="09:30_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="10:00" binding="data_1000_am" id="10:00" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="10:00" binding="data_1000_am2" id="10:00_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="10:00" binding="data_1000_pm" id="10:30" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="10:00" binding="data_1000_pm2" id="10:30_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="11:00" binding="data_1100_am" id="11:00" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="11:00" binding="data_1100_am2" id="11:00_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="11:00" binding="data_1100_pm" id="11:30" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="11:00" binding="data_1100_pm2" id="11:30_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="12:00" binding="data_1200_am" id="12:00" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="12:00" binding="data_1200_am2" id="12:00_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="12:00" binding="data_1200_pm" id="12:30" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="12:00" binding="data_1200_pm2" id="12:30_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="13:00" binding="data_1300_am" id="13:00" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="13:00" binding="data_1300_am2" id="13:00_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="13:00" binding="data_1300_pm" id="13:30" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="13:00" binding="data_1300_pm2" id="13:30_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="14:00" binding="data_1400_am" id="14:00" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="14:00" binding="data_1400_am2" id="14:00_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="14:00" binding="data_1400_pm" id="14:30" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="14:00" binding="data_1400_pm2" id="14:30_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="15:00" binding="data_1500_am" id="15:00" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="15:00" binding="data_1500_am2" id="15:00_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="15:00" binding="data_1500_pm" id="15:30" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="15:00" binding="data_1500_pm2" id="15:30_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="16:00" binding="data_1600_am" id="16:00" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="16:00" binding="data_1600_am2" id="16:00_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="16:00" binding="data_1600_pm" id="16:30" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="16:00" binding="data_1600_pm2" id="16:30_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="17:00" binding="data_1700_am" id="17:00" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="17:00" binding="data_1700_am2" id="17:00_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="17:00" binding="data_1700_pm" id="17:30" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="17:00" binding="data_1700_pm" id="17:30_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>            
            <wj-flex-grid-column header="18:00" binding="data_1800_am" id="18:00" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="18:00" binding="data_1800_am2" id="18:00_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="18:00" binding="data_1800_pm" id="18:30" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="18:00" binding="data_1800_pm2" id="18:30_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>            
            <wj-flex-grid-column header="19:00" binding="data_1900_am" id="19:00" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="19:00" binding="data_1900_am2" id="19:00_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="19:00" binding="data_1900_pm" id="19:30" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="19:00" binding="data_1900_pm2" id="19:30_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>            
            <wj-flex-grid-column header="20:00" binding="data_2000_am" id="20:00" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="20:00" binding="data_2000_am2" id="20:00_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="20:00" binding="data_2000_pm" id="20:30" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="20:00" binding="data_2000_pm2" id="20:30_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>            
            <wj-flex-grid-column header="21:00" binding="data_2100_am" id="21:00" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="21:00" binding="data_2100_am2" id="21:00_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="21:00" binding="data_2100_pm" id="21:30" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="21:00" binding="data_2100_pm2" id="21:30_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>            
            <wj-flex-grid-column header="22:00" binding="data_2200_am" id="22:00" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="22:00" binding="data_2200_am2" id="22:00_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="22:00" binding="data_2200_pm" id="22:30" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="22:00" binding="data_2200_pm2" id="22:30_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="23:00" binding="data_2300_am" id="23:00" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="23:00" binding="data_2300_am2" id="23:00_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="23:00" binding="data_2300_pm" id="23:30" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="23:00" binding="data_2300_pm2" id="23:30_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="24:00" binding="data_2400_am" id="24:00" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="24:00" binding="data_2400_am2" id="24:00_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="24:00" binding="data_2400_pm" id="24:30" :width="100" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="24:00" binding="data_2400_pm2" id="24:30_space" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <!--
            ...
            <div class="area009-005">
              ...
              <textarea  id="textarea_day" class="clssinp009-001" v-model="disptok_day" 
              @click="click_text" @input="initTextarea(1)"></textarea>              
            </div>
        </div>
        ...
        <div class="area009-007">
            ...
            :initialized="onInitializeIcrnGrid_week"
            :itemsSource="viewdata_week"
            :itemsSourceChanged="onItemsSourceChanged_week"
            :autoRowHeights="true"            
            >
            <wj-flex-grid-column header=" " binding="data_kbn" id="data_kbn" :width="85" :isReadOnly="true" :wordWrap=true :allowResizing=false align="center" ></wj-flex-grid-column>
            <wj-flex-grid-column header="月" binding="data_mon"  id="data_mon" :width="120" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="月" binding="data_mon2"  id="data_mon2" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="火" binding="data_tue"  id="data_tue" :width="120" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="火" binding="data_tue2" id="data_tue2" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="水" binding="data_wed" id="data_wed" :width="120" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="水" binding="data_wed2"  id="data_wed2" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="木" binding="data_thu" id="data_thu" :width="120" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="木" binding="data_thu2"  id="data_thu2" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="金" binding="data_fri" id="data_fri" :width="120" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="金" binding="data_fri2" id="data_fri2" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="土" binding="data_sat" id="data_sat" :width="120" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="土" binding="data_sat2" id="data_sat2" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="日" binding="data_sun" id="data_sun" :width="120" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            <wj-flex-grid-column header="日" binding="data_sun2" id="data_sun2" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>

            </wj-flex-grid>         

            <div class="area009-008">
              <label class="clsstitle009-006">特記事項</label>
              <textarea  id="textarea_week" class="clssinp009-002" v-model="disptok_week" 
                @click="click_text" @input="initTextarea(2)"></textarea>              
            </div>
        </div>
       ...
       <v-dialog  v-model="Insdaywin" width="435">
          ...
          <div>
            ...
            <div class="day_area001 mt-2">
              ...
              <select
                class="customSelectBox ml-1"
                v-model="dispstime"
                @change="onstimeClicked"
            ...
            <div class="day_area001 mt-2">
                ...
                <input type="text" id="txtdaysca" class="day_textsca" v-model="dispscanaiyo" @input="scatext_input" />
            </div>
...
-->
        ...
        <v-sheet id="rireki_id009" class="clssheet-Reki" elevation="2"
...
<script>
    ...
    let DEL_KBN_BIKO = 2;    //削除区分:備考
    let DEL_KBN_ALL = 3;    //削除区分:全データ
