<template>
    <v-sheet class="clssheet-chu018" elevation="2">
      ...
      <label class="clsstitle1_Noreki_back_018" v-show="Label_Visible">
        <label class="clsstitle1_Noreki_018" >履歴を作成してください</label>
      </label>
        ...
        <div class="area018-004">
            ...
            :selectionMode="'Row'"
            :isReadOnly="true"
            :initialized="onInitializeIcrnGrid001"
            :itemsSourceChanged="onItemsSourceChanged"
            :itemsSource="viewdata_syogai"
            :autoRowHeights="true"
            >

            <wj-flex-grid-column header="サービス内容" binding="kaigo_svstext" :width="185"  :wordWrap=true :allowResizing=false multiLine="true" ></wj-flex-grid-column>
            <wj-flex-grid-column header="提供機関・提供者" binding="kaigo_teikyotext" :width="185" :wordWrap=true :allowResizing=false multiLine="true"></wj-flex-grid-column>
            <wj-flex-grid-column header="支援内容" binding="kaigo_sientext" :width="185" :wordWrap=true :allowResizing=false multiLine="true"></wj-flex-grid-column>
            <wj-flex-grid-column header="頻度" binding="kaigo_hindotext" :width="105" :wordWrap=true :allowResizing=false multiLine="true"></wj-flex-grid-column>
            <wj-flex-grid-column header="備考" binding="kaigo_biko" :width="265" :wordWrap=true :allowResizing=false multiLine="true"></wj-flex-grid-column>
        ...
        <div class="area018-006">
            ...
            :selectionMode="'Row'"
            :isReadOnly="true"
            :initialized="onInitializeIcrnGrid002"
            :itemsSourceChanged="onItemsSourceChanged"
            :itemsSource="viewdata_kaigo"
            :autoRowHeights="true"
            >
            <wj-flex-grid-column header="サービス内容" binding="kaigo_svstext" :width="185"  :wordWrap=true :allowResizing=false multiLine="true" ></wj-flex-grid-column>
            <wj-flex-grid-column header="提供機関・提供者" binding="kaigo_teikyotext" :width="185" :wordWrap=true :allowResizing=false multiLine="true"></wj-flex-grid-column>
        ...
        <div class="area018-008">
            ...
            :selectionMode="'Row'"
            :isReadOnly="true"
            :initialized="onInitializeIcrnGrid003"
            :itemsSourceChanged="onItemsSourceChanged"
            :itemsSource="viewdata_sonota"
            :autoRowHeights="true"
            >
            <wj-flex-grid-column header="サービス内容" binding="kaigo_svstext" :width="185"  :wordWrap=true :allowResizing=false multiLine="true" ></wj-flex-grid-column>
            <wj-flex-grid-column header="提供機関・提供者" binding="kaigo_teikyotext" :width="185" :wordWrap=true :allowResizing=false multiLine="true"></wj-flex-grid-column>
        ...
        <v-sheet id="rireki_id018" class="clssheet-Reki" elevation="2"
        ...
        <v-sheet class="clssheet-chu019" elevation="2">
          ...
          <div class="area019-009">
              ...
              <div class="area019-003">
                  ...
                  <input type="text" id="clssinp019-001_id" class="clssinp019-001" v-model="dispsvc_text" @click="text_click(1)" @input="text_input(0)">
              </div>

              <div class="area019-004">
                  <label class="clsstitle019-003">提供機関・提供</label>
                  <input type="text" id="clssinp019-002_id" class="clssinp019-002" v-model="dispkankei_text" @click="text_click(2)" @input="text_input(1)">
              </div>

              <div class="area019-005">
                  <label class="clsstitle019-004">支援内容</label>
                  <input type="text" id="clssinp019-003_id" class="clssinp019-003" v-model="dispsien_text" @click="text_click(3)" @input="text_input(2)">
              </div>

              <div class="area019-006">
                  <label class="clsstitle019-005">頻度</label>
                  <input type="text" id="clssinp019-004_id" class="clssinp019-004" v-model="disphindo_text" @click="text_click(4)" @input="text_input(3)">
              </div>

              <div class="area019-007">
                  <label class="clsstitle019-006">備考</label>
                  <textarea  id="clssinp019-005_id" class="clssinp019-005" v-model="dispbiko_text" @click="text_click(5)" @input="text_input(4)"></textarea>              
              </div>
          </div>
              <div class="area019-010">
                ...
                <div class="arearadio018">
                  <div   class="arearadio018-2" v-show="this.inputMstflg == 2 && radio_visible">
                    ...
                    <v-radio id="radio_jigyo_j" class="radio_jigyo" value="radio_J" @click="click_radio(0)">s
                ...
                <wj-flex-grid
                  ...
                  :selectionMode="'Row'"
                  :isReadOnly="true"
                  :initialized="onInitializeIcrnGridwin"
                  :itemsSourceChanged="onItemsSourceChanged_win"
                  :itemsSource="viewinputdata"
                  :autoRowHeights="true"
                >
                <wj-flex-grid-column header="サービス種類" binding="name1" :width="140"  :wordWrap=true  :allowMerging = true :allowResizing=false ></wj-flex-grid-column>
                <wj-flex-grid-column header="サービス種類" binding="name2" :width="235"  :wordWrap=true :allowMerging = true :allowResizing=false ></wj-flex-grid-column>                
