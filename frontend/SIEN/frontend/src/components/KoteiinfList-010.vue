<template>
    <v-sheet class="clssheet-chu010" elevation="2">
        ...
        <label class="clsstitle1_Noreki_back_010" v-show="Label_Visible">
          <label class="clsstitle1_Noreki_010" >履歴を作成してください</label>
        </label>
        ...
        <div class="area010-007" >
          <v-btn :disabled="Label_Visible == true" id="clsbtnmenu-del-id" class="clsbtnmenu010-del" @click="onClickdel">
              削  除
          </v-btn>
       ...
       <v-dialog v-model="InsWinhead" width="255" >
        ...
        <v-sheet  class="clssheet-Reki" elevation="2"
            id="rireki_id010"
          ...
          <div class="areaReki2">          
            <wj-flex-grid
                ...
                :selectionMode="'Row'"
                :isReadOnly="true"
                :initialized="onInitializeIcrnGrid_reki"
                :itemsSourceChanged="onItemsSourceChanged_reki"
        ...
        <v-dialog v-model="InsWindata" width="745"  >
          <v-sheet class="clssheet-chu011" elevation="2"
            id ="data_010id">
            <!--
            ...
            <div class="areainput2"> 
              <div class="area011-003">
                  ...
                  <input type="text" id="clssinp011-003_id" class="clssinp011-003" v-model="dispkzkname" @input="text_input(0)"/>
              </div>

              <div class="area011-004">
                  <label class="clsstitle011-004">家族カナ</label>
                  <input type="text" id="clssinp011-004_id" class="clssinp011-004" v-model="dispkzkkana" @input="text_input(1)"/>
              </div>

              <div class="area011-005">
                  <label class="clsstitle011-005">続柄</label>
                  <input type="text" class="clssinp011-005" v-model = "dispkzktuduki" @click="onTxtTuduki_Click" readonly/>
              </div>
            </div>
            ...
            <div v-show="Grid_Visible" class="areatuduki">
              <div >
                <wj-flex-grid
                  ...
                  >
                  <!--列-->
                  <wj-flex-grid-column header="続柄" binding="namedai" :width="80" :wordWrap=true :allowMerging = true :allowResizing=false id="MstGrid_col1"></wj-flex-grid-column>
                  <wj-flex-grid-column header="続柄" binding="clear" :width="0" :wordWrap=true :allowMerging = true :allowResizing=false id="MstGrid_col1"></wj-flex-grid-column>
                  <wj-flex-grid-column header="続柄" binding="namechu" :width="130" :wordWrap=true :allowMerging = true :allowResizing=false id="MstGrid_col1"></wj-flex-grid-column>
                  <wj-flex-grid-column header="" binding="daiid" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
                  <wj-flex-grid-column header="" binding="chuid" :width="0" :wordWrap=true :allowResizing=false ></wj-flex-grid-column>
            ...
            <div class="area011-008">
                ...
                <input class="chk011-001" type="checkbox" id="chksyukaigo" v-model="dispkaigokbn" @click="check_click(0)">
                <label id="chklabel011-001_id" class="chklabel011-001">主介護者</label>
                <input class="chk011-002" type="checkbox" id="chkfuku1" v-model="dispkaigokbn_fuku1" @click="check_click(1)">
                <label id="chklabel011-002_id" class="chklabel011-002" >副介護者①</label>
                <input class="chk011-003" type="checkbox" id="chkfuku2" v-model="dispkaigokbn_fuku2" @click="check_click(2)">
            ...
            <div class="area011-010">
                ...
                <input class="chk011-005" type="checkbox" id="chkkinkyu1" v-model="dispkinkyu1" @click="check_click_kinkyu(0)">
                <label id="chklabel011-005_id" class="chklabel011-005">緊急連絡者①</label>
                <input class="chk011-006" type="checkbox" id="chkkinkyu2" v-model="dispkinkyu2" @click="check_click_kinkyu(1)">
            ...
            <div class="area011-012">
                ...
                <div class="area011-012-001">
                    ...
                    <input type="text" id ="clssinp011-012-001_id" class="clssinp011-012-001" v-model="dispyubin1" @input="text_input(2)"/>
                    <label class="clsstitle011-012-002">ー</label>
                    <input type="text" id="clssinp011-012-002_id" class="clssinp011-012-002" v-model="dispyubin2" @input="text_input(3)"/>
                    <textarea type="text" id="clssinp011-012-003_id" class="clssinp011-012-003" v-model="dispadress" @input="text_input(4)"/>
                </div>
            </div>

            <div class="area011-013">
                <label class="clsstitle011-013">連絡先①</label>
                <input type="text" id="clssinp011-013-001_id" class="clssinp011-013-001" v-model="disprenraku1_1" @input="text_input(5)" />
                <label class="clsstitle011-013-001">ー</label>
                <input type="text" id="clssinp011-013-002_id" class="clssinp011-013-002" v-model="disprenraku1_2" @input="text_input(6)" />
                <label class="clsstitle011-013-002">ー</label>            
                <input type="text" id="clssinp011-013-003_id" class="clssinp011-013-003" v-model="disprenraku1_3" @input="text_input(7)" />               
            </div>

            <div class="area011-014">
                <label class="clsstitle011-014">連絡先②</label>
                <input type="text" id="clssinp011-014-001_id" class="clssinp011-014-001" v-model="disprenraku2_1" @input="text_input(8)" />
                <label class="clsstitle011-014-001">ー</label>
                <input type="text" id="clssinp011-014-002_id" class="clssinp011-014-002" v-model="disprenraku2_2" @input="text_input(9)" />
                <label class="clsstitle011-014-002">ー</label>            
                <input type="text" id="clssinp011-014-003_id" class="clssinp011-014-003" v-model="disprenraku2_3" @input="text_input(10)" />               
            </div>    
          
            <div class="area011-015">
                <label class="clsstitle011-014">FAX番号</label>
                <input type="text" id="clssinp011-015-001_id" class="clssinp011-014-001" v-model="dispfaxno1" @input="text_input(11)"/>
                <label class="clsstitle011-014-001">ー</label>
                <input type="text" id="clssinp011-015-002_id" class="clssinp011-014-002" v-model="dispfaxno2" @input="text_input(12)"/>
                <label class="clsstitle011-014-002">ー</label>            
                <input type="text" id="clssinp011-015-003_id" class="clssinp011-014-003" v-model="dispfaxno3" @input="text_input(13)"/>               
            </div>          

            <div class="area011-016">
                <label class="clsstitle011-016">Eメール</label>
                <input type="text" id="clssinp011-016_id" class="clssinp011-016" v-model="dispemail" @input="text_input(14)"/>
            </div>

            <div class="area011-017">
                <label class="clsstitle011-017">携帯メール</label>
                <input type="text" id="clssinp011-017_id" class="clssinp011-017" v-model="dispkmail" @input="text_input(15)" />
            </div>        

            <div class="area011-018">
                <label class="clsstitle011-018">勤務・学校</label>
                <div class="area011-018-001">
                <input class="chk011-008" type="checkbox" id="chkkinmu1" v-model="dispkinmu1" @click="check_click_kinmu(0)">
                <label id="chklabel011-008_id" class="chklabel011-008">就労</label>
                <input class="chk011-009" type="checkbox" id="chkkinmu2" v-model="dispkinmu2" @click="check_click_kinmu(1)">
                <label id="chklabel011-009_id" class="chklabel011-009" >就学</label>
                </div>
                <input type="text" id="clssinp011-018_id" class="clssinp011-018" v-model="dispkinmu_biko" @input="text_input(16)"/>
            </div>

            <div class="area011-019">
                <label class="clsstitle011-019">備考</label>
                <textarea type="text" id="clssinp011-019_id" class="clssinp011-019" v-model="dispbiko" @input="text_input(17)"/>
            </div>  
