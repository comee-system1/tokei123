<template>
    <v-sheet class="clssheet-chu010" elevation="2">
        ...
        <div class="area010-007">
            ...
            <v-btn :disabled="Label_Visible == true" id="clsbtnmenu-ins-id" class="clsbtnmenu010-ins"
                @click="onClickIns">
                登 録
            </v-btn>
        </div>
            ...
            @mouseup="win_up_data($event)">-->
                ...
                <div class="area011-006">
                    ...
                    <v-radio-group row v-model="radio006" class="radiogroup001">
                        ...
                        <v-radio class="clssinp011-006-hidoukyo" label="非同居" value="radio006-H"
                            @click="click_radio(61)">
                            <template v-slot:label>
                ...
                <div class="area011-009">
                    ...
                    <div class="area011-009-001">
                        <input class="chk011-004" type="checkbox" id="chkmimoto" v-model="dispmimoto"
                            @click="check_mimoto">
