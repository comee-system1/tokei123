        ...
        <div class="area012-005">
            ...
            <div class="area012-005-001">
                ...
                <div class="area012-005-001-renraku1">
                    ...
                    <input type="text" id="clssinp012-006-001_id" class="clssinp012-006-001"
                        v-model="dispkoken_renranku1_1" @input="text_input(5)" />
                    <label class="clsstitle012-007-002">ー</label>
                    <input type="text" id="clssinp012-006-002_id" class="clssinp012-006-002"
                        v-model="dispkoken_renranku1_2" @input="text_input(6)" />
                    <label class="clsstitle012-007-003">ー</label>
                    <input type="text" id="clssinp012-006-003_id" class="clssinp012-006-003"
                        v-model="dispkoken_renranku1_3" @input="text_input(7)" />
                </div>

                <div class="area012-005-001-renraku2">
                    <label class="clsstitle012-007-004">連絡先②</label>
                    <input type="text" id="clssinp012-006-004_id" class="clssinp012-006-004"
                        v-model="dispkoken_renranku2_1" @input="text_input(8)" />
                    <label class="clsstitle012-007-005">ー</label>
                    <input type="text" id="clssinp012-006-005_id" class="clssinp012-006-005"
                        v-model="dispkoken_renranku2_2" @input="text_input(9)" />
                    <label class="clsstitle012-007-006">ー</label>
                    <input type="text" id="clssinp012-006-006_id" class="clssinp012-006-006"
                        v-model="dispkoken_renranku2_3" @input="text_input(10)" />
                </div>
            </div>
        </div>
