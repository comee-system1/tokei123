...
const JIGYOKBN={
    Kihon:{val:0,name:'基本情報'},
    Taiin:{val:1,name:'退院サポート'},
    Jiritu:{val:2,name:'自立アシスト'},
    Renraku:{val:3,name:'連絡調整'},
}
const KEIKAKUJIGYOKBN={
    Keikaku:{val:0,name:'計画相談'},
    Syougaiji:{val:1,name:'障害児相談'},
}
const CHIIKIJIGYOKBN={
    Keikaku:{val:0,name:'地域移行'},
    Syougaiji:{val:1,name:'地域定着'},
}
