<template>
    <div id="serviceHistory" class="mt-n1">
        ...
        <v-container fluid class="container mt-0 user-info">
            ...
            <riyousyadaityo-sort-menu @displaySort="displaySort($event)" @sorted="sorted($event)" @alphabeted="alphabeted($event)" @selectedServiceJigyo="selectedServiceJigyo($event)" @selectedServiceNaiyo="selectedServiceNaiyo($event)" @kanaSearch="kanaSearch($event)"
                :kihonJyohoFlag="false" :serviceHistoryFlag="true" ref="childRiyousyadaityo"></riyousyadaityo-sort-menu>
    
            <wj-flex-grid id="serviceHistoryGrid" :initialized="onInitialized" :itemsSourceChanged="onItemsSourceChanged" :selectionMode="3" :allowMerging="6" :headersVisibility="'Column'" :allowDragging="false" :allowResizing="true" :deferResizing="false" :allowSorting="false"
                :autoRowHeights="true" :itemsSource="historyData">
    
                <wj-flex-grid-column :binding="'riyocode'" align="center" valign="middle" :width="75" format="g" :allowResizing="false" :isReadOnly="true" :visible="isVisible1"></wj-flex-grid-column>
    
                <wj-flex-grid-column :binding="'names'" align="left" valign="middle" :width="160" :isReadOnly="true" :allowResizing="true" :visible="isVisible1" :multiLine="true" :wordWrap="true"></wj-flex-grid-column>
    
    
    
                <wj-flex-grid-column :binding="'serviceTeikyoJigyosyoCode'" align="center" valign="middle" :width="60" :isReadOnly="true" :allowResizing="false" format="g"></wj-flex-grid-column>
    
                <wj-flex-grid-column :binding="'serviceTeikyoJigyosyo'" align="left" valign="middle" :width="255" :isReadOnly="true" :multiLine="true" :wordWrap="true"></wj-flex-grid-column>
    
                <wj-flex-grid-column :binding="'serviceCode'" align="center" valign="middle" :width="30" format="g" :isReadOnly="true" :allowResizing="false"></wj-flex-grid-column>
    
                <wj-flex-grid-column :binding="'serviceMeisyo'" align="left" valign="middle" :width="205" :isReadOnly="true" :multiLine="true" :wordWrap="true"></wj-flex-grid-column>
    
                <wj-flex-grid-column :binding="'riyocode'" align="center" valign="middle" :width="75" format="g" :allowResizing="false" :isReadOnly="true" :visible="isVisible2"></wj-flex-grid-column>
    
                <wj-flex-grid-column :binding="'names'" align="left" valign="middle" :width="135" :isReadOnly="true" :multiLine="true" :wordWrap="true" :visible="isVisible2"></wj-flex-grid-column>
    
    
    
                <wj-flex-grid-column :binding="'spice'" align="center" valign="middle" :width="30" :allowResizing="false" :isReadOnly="true"></wj-flex-grid-column>
    
                <wj-flex-grid-column :binding="'startDate'" :header="'開始日'" align="center" valign="middle" :width="100" :allowResizing="false" :isReadOnly="true"></wj-flex-grid-column>
    
                <wj-flex-grid-column :binding="'endDate'" :header="'終了日'" align="center" valign="middle" :width="100" :allowResizing="false" :isReadOnly="true"></wj-flex-grid-column>
    
                <wj-flex-grid-column :binding="'processTime'" align="right" valign="middle" :width="100" :allowResizing="false" :isReadOnly="true"></wj-flex-grid-column>
    
            </wj-flex-grid>
    
        </v-container>
    
        <dialog-service-history ref="dialog_service" :historyData="historyData"></dialog-service-history>
