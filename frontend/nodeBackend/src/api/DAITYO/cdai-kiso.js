const Service = require('../../DAITYO/cdai-kiso/Service')
...
exports.connected = async function (param) {
  ...
  var url = apiRun.getDomain() + '/kyotu/mst/v1/daityo/cdai-kiso?' + apiRun.getQuery();
  apiRun.setURL(url);
...
exports.registed = async function (param, data) {
  ...
  let url = apiRun.getDomain() + '/kyotu/mst/v1/daityo/cdai-kiso?' + apiRun.getQuery();
  apiRun.setURL(url);
  apiRun.setUniqID(param.uniqid);
  apiRun.setTraceID(param.traceid);
