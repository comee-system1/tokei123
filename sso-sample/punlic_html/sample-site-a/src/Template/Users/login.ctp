...
<div style="margin: 22px; text-align: right">
    <a href="https://comee-sample.auth.us-east-2.amazoncognito.com/login?response_type=code&client_id=61ocakkq1t8p7nb3lcmd2rl893&redirect_uri=http://localhost/users/cognito-callback" class="btn" style="background-color: coral;">Cognito Sample Login</a>
